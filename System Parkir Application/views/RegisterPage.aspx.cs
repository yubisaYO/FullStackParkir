    ...
    public partial class RegisterPage : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if(!(username.Equals("")) && !(platNomor.Equals(""))){
                ...
                if (!ParkirRepository.validatePlatNomor(platNomor))
                {
                    lblError.CssClass = "alert alert-danger d-block";
                    lblError.Text = "Plat Nomor Is Already in Parking Area";
                }
                else if (SlotFound != null)
                {
                    // make new ticket
                    ...
                    ParkirFactory.CreateParkir((int)ticket.tiketID, (int)pengemudi.pengemudiID, SlotFound.parkirID);
                    lblError.CssClass = "alert alert-success d-block";
                    //lblError.Text = "Tiket ID = " + ticket.tiketID + " Pengemudi ID = " + pengemudi.pengemudiID + "Lantai " + SlotFound.lantai;
                    lblError.Text = "Succesfully Register with tiket id : " + ticket.tiketID;
